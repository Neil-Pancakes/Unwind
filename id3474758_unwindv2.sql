...
--
-- Host: localhost
-- Generation Time: Dec 01, 2017 at 07:13 AM
...
CREATE TABLE `reservation_request` (
  ...
  `reservation_request_status` enum('Accepted','Rejected','Pending','Cancelled') NOT NULL,
...
INSERT INTO `reservation_request` (`reservation_request_id`, `reservation_request_date`, `checkin_date`, `checkout_date`, `reservation_request_status`, `user_id`, `employee_id`) VALUES
(4, '2017-11-18 04:39:26', '2017-11-20', '2017-11-23', 'Cancelled', 5, NULL),
(5, '2017-11-22 16:55:43', '2017-11-29', '2017-12-08', 'Pending', 5, NULL),
(6, '2017-11-25 01:12:18', '2017-12-19', '2017-12-23', 'Pending', 5, NULL),
(7, '2017-11-25 01:23:00', '2018-03-15', '2018-04-15', 'Pending', 5, NULL),
(8, '2017-11-25 01:41:08', '2018-05-15', '2018-05-20', 'Pending', 5, NULL),
(9, '2017-11-25 01:44:37', '2018-06-15', '2018-06-18', 'Pending', 5, NULL);
...
--
ALTER TABLE `reservation_request`
  MODIFY `reservation_request_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
